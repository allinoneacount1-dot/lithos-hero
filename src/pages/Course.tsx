  ...
  return (
    ...
    >
      <div
        ...
        className="hero-card group bg-white/5 border border-white/10 rounded-xl p-5 hover:border-[#e8702a]/30 cursor-pointer"
      >
...
export default function Course() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] pt-28 px-6 sm:px-14 relative">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#e8702a]/3 blur-[150px] rounded-full pointer-events-none hero-glow-orbit" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-white/3 blur-[120px] rounded-full pointer-events-none hero-glow-orbit-reverse" />
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Filters */}
        <div ref={filtersRef} className="hero-scroll-reveal flex flex-wrap gap-2 mb-8" style={{ transitionDelay: '0.15s' }}>
          {levels.map((f) => (
            <button
              key={f}
              onClick={() => setLevel(f)}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
          {filtered.map((c, i) => <CourseCard key={i} c={c} i={i} />)}
        </div>

        {/* Instructor CTA */}
        <div ref={ctaRef} className="hero-scroll-reveal" style={{ transitionDelay: '0.2s' }}>
          <div className="bg-gradient-to-r from-[#e8702a]/10 to-transparent border border-[#e8702a]/20 rounded-xl p-6 sm:p-8 mb-16">
