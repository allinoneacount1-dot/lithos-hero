...
const guides = [
  { title: 'Solana Validator Setup', protocol: 'Jito-Solana', pages: 52, difficulty: 'Advanced', downloads: '8.2k', rating: 4.8, author: 'Jito Labs' },
  { title: 'Anchor Framework Deep Dive', protocol: 'Anchor Lang', pages: 44, difficulty: 'Intermediate', downloads: '14k', rating: 4.9, author: 'Coral Foundation' },
  { title: 'Token Extensions Guide', protocol: 'Token 2022', pages: 38, difficulty: 'Beginner', downloads: '11k', rating: 4.7, author: 'Solana Foundation' },
  { title: 'SVM Runtime Internals', protocol: 'Sealevel', pages: 56, difficulty: 'Advanced', downloads: '5.4k', rating: 4.6, author: 'Anza' },
  { title: 'Solana DeFi Risk Matrix', protocol: 'Marginfi & Kamino', pages: 32, difficulty: 'Intermediate', downloads: '6.7k', rating: 4.5, author: 'Gauntlet' },
  { title: 'On-Chain AI Inference', protocol: 'Giza & Render', pages: 28, difficulty: 'Beginner', downloads: '3.9k', rating: 4.4, author: 'Giza' },
  { title: 'ZK Compression Deep Dive', protocol: 'Light Protocol', pages: 40, difficulty: 'Advanced', downloads: '2.8k', rating: 4.7, author: 'Light Protocol' },
  { title: 'Solana Pay Integration', protocol: 'Solana Pay', pages: 24, difficulty: 'Beginner', downloads: '7.1k', rating: 4.6, author: 'Solana Labs' },
  { title: 'NFT Compressed Minting', protocol: 'Metaplex & 3Land', pages: 36, difficulty: 'Intermediate', downloads: '4.5k', rating: 4.5, author: 'Metaplex' },
]
            ...
            >
              ...
              <div className="flex items-center justify-between pt-3 border-t border-white/5">
                ...
                <div className="flex gap-1.5">
                  <button className="text-xs bg-white/10 hover:bg-[#e8702a] text-white px-3 py-1 rounded-full transition-all flex items-center gap-1">
                    Read <ArrowUpRight size={10} />
                  </button>
                  <button className="text-xs bg-white/5 hover:bg-white/10 text-white/40 hover:text-white px-3 py-1 rounded-full transition-all">
                    <Download size={11} />
                  </button>
                </div>
              </div>
        ...
        <div className="bg-gradient-to-r from-white/5 to-transparent border border-white/10 rounded-xl p-6 sm:p-8 mb-10 hero-anim hero-fade" style={{ animationDelay: '0.6s' }}>
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
            ...
            <div className="flex-1">
              ...
              <h3 className="text-white text-lg font-semibold mt-1 mb-1">Anchor Framework Deep Dive</h3>
              <p className="text-white/50 text-sm max-w-lg">The most comprehensive guide to Solana's Anchor framework. Updated for Anchor 0.31 with PDA derivation, CPI security, and testing best practices.</p>
            ...
            <button className="bg-white/10 hover:bg-white/20 text-white text-sm px-6 py-2.5 rounded-full transition-all shrink-0 mt-2 sm:mt-0">Read now →</button>
          </div>
        </div>
      </div>
    </div>
